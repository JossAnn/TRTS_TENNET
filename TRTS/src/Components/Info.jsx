    ...
    return (
        <div className="w-full h-full col-span-10 grid grid-cols-2 bg-[#A49C9F] custom-shadow rounded-bl-2xl rounded-br-2xl text-white">
            <div className="col-span-1 flex flex-col items-center justify-center">
                ...
                <input type="text" disabled className="w-[80%] font-bold rounded-lg bg-[#9A9087] h-8  placeholder-white outline-none pl-2 text-center border-2 border-solid border-[#B0A9A4]" placeholder='Container 1'/><br />
                <strong><label htmlFor="">Type</label></strong>
                <input type="text" disabled className="w-[80%] font-bold rounded-lg bg-[#9A9087] h-8 placeholder-white outline-none pl-2 text-center border-2 border-solid border-[#B0A9A4]" placeholder='Pleurotus ostreatus'/><br />
                <strong><label htmlFor="" className="text-left">Substratum</label></strong>
                <input type="text" disabled className="w-[80%] rounded-lg bg-[#9A9087] font-bold h-8  placeholder-white outline-none pl-2 text-center border-2 border-solid border-[#B0A9A4]" placeholder='peanut shell'/><br />
                <strong><label htmlFor="">Start day</label></strong>
                <input type="text" disabled className="w-[80%] rounded-lg font-bold bg-[#9A9087] h-8 placeholder-white outline-none pl-2 text-center border-2 border-solid border-[#B0A9A4]" placeholder='21/11/23'/><br />
                <strong><label htmlFor="" className="text-left">End day</label></strong>
                <input type="text" disabled className="w-[80%] rounded-lg font-bold bg-[#9A9087] h-8 placeholder-white outline-none pl-2 text-center border-2 border-solid border-[#B0A9A4]" placeholder='21/12/23'/>
            </div>
